...
export const CARE_QUALITY_AREAS: readonly CareQualityArea[] = [
  ...
  { key: "care-plans", title: "Care plans and reviews", description: "One live person-centred care plan with controlled versions, review proposals, staff instructions and RM assurance.", href: "/care-plans", createHref: "/care-plans/new", registerKeys: ["care-plan-reviews"] },

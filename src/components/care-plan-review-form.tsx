    ...
    <div className="grid gap-5 xl:grid-cols-[250px_minmax(0,1fr)_280px]">
      ...
      <div className="min-w-0 rounded-2xl border border-slate-200 bg-white p-5 shadow-sm sm:p-7">
        ...
        <StepPanel active={step === 9} number={10} title="Outcome review" description="Show whether agreed outcomes are being achieved and what evidence supports the judgement.">
          <TextArea name="reviewData.outcomeTable" label="Outcome review table" defaultValue={stored(data,"outcomeTable")} placeholder="Outcome | Previous status | Current progress | Evidence | Person's view | Continue/amend/close | New target | Review date" wide/>

...
export default async function PoliciesPage({ searchParams }: { searchParams: Promise<Record<string, string | string[] | undefined>> }) {
  ...
  return <main className="space-y-6">
    ...
    {canEdit ? <Link href="/policies/catalogue" className="block rounded-2xl border border-emerald-200 bg-emerald-50 p-5 transition hover:border-emerald-500"><p className="text-xs font-bold uppercase tracking-widest text-emerald-700">New premium product</p><h2 className="mt-1 text-xl font-bold text-emerald-950">Build your branded policy suite</h2><p className="mt-2 text-sm leading-6 text-emerald-900">Choose source-grounded adult social care policies, assign an owner and create controlled drafts ready for local review and approval.</p></Link> : null}

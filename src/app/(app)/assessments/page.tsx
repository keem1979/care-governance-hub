...
export default async function AssessmentsPage(){
  ...
  return <main className="space-y-7">
    <header><p className="text-sm font-bold uppercase tracking-widest text-emerald-700">Care and service assurance</p><h1 className="text-3xl font-bold">Assessment Centre</h1><p className="mt-1 max-w-3xl text-slate-600">A guided assessment pathway for starting care, confirming consent, managing individual risks and assessing service-wide impact.</p></header>

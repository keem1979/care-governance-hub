...
export default async function EditActionPage({ params }: { params: Promise<{ id: string }> }) {
  ...
  try {
    const [action, memberships, evidence, sources] = await Promise.all([

    ...
    return <main className="mx-auto max-w-7xl space-y-6">
      <header>
        ...
        <div className="mt-2 flex flex-wrap items-start justify-between gap-4">
          <div><p className="text-sm font-bold uppercase tracking-widest text-emerald-700">Monthly service performance</p><h1 className="text-3xl font-bold">{existing ? "Update monthly performance return" : "Start monthly performance return"}</h1><p className="mt-1 max-w-3xl text-slate-600">Record branch activity once, check the figures, and use the saved summary for internal governance or contract reporting.</p></div>

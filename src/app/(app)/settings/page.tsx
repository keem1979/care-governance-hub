  ...
  try {
    ...
    return (
      <main className="space-y-8">
        ...
        {canOrganisation ? <section className="grid gap-4 lg:grid-cols-2"><div className="rounded-2xl border border-emerald-200 bg-emerald-50 p-6"><p className="text-xs font-bold uppercase tracking-widest text-emerald-700">Governed settings</p><h2 className="mt-1 text-xl font-bold">Organisation Risk Framework</h2><p className="mt-2 text-sm text-slate-700">Control versioned appetite, tolerance and proportionate Risk closure authority.</p><Link href="/settings/risk-framework" className="mt-4 inline-flex rounded-lg bg-emerald-700 px-4 py-2 text-sm font-bold text-white">Manage Risk Framework</Link></div><div className="rounded-2xl border border-blue-200 bg-blue-50 p-6"><p className="text-xs font-bold uppercase tracking-widest text-blue-700">Action assurance</p><h2 className="mt-1 text-xl font-bold">Audit Action Assurance Policy</h2><p className="mt-2 text-sm text-slate-700">Version provider rules for verification, effectiveness, separation and closure authority on Audit-sourced Actions.</p><Link href="/settings/action-assurance" className="mt-4 inline-flex rounded-lg bg-blue-800 px-4 py-2 text-sm font-bold text-white">Manage Action Assurance</Link></div></section> : null}
